...
mark("statement=}###line-of-blockin-function=1");}int main(){try{int a=10;int b=0;divisionTest(a,b); }catch(exception& error){build="Phat hien loi runtime";}return 0;}
